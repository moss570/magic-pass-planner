...
export default function PicturePerfectGame({ onClose }: { onClose: () => void }) {
  ...
  if (gameOver || guessed) {
    return (
      <div className="min-h-screen bg-cover bg-center" style={backgroundImage: `url(/game-backgrounds/bg-picture-perfect.jpg`} p-4 flex items-center justify-center relative overflow-hidden">
  ...
  return (
    <div className="min-h-screen bg-cover bg-center" style={backgroundImage: `url(/game-backgrounds/bg-picture-perfect.jpg`} p-4 relative overflow-hidden">
      <><div className="absolute inset-0 bg-black/60 pointer-events-none" /><div className="fixed inset-0 pointer-events-none">
        <div className="absolute top-1/4 left-1/3 w-72 h-72 rounded-full blur-[100px] opacity-20 bg-pink-500" />
