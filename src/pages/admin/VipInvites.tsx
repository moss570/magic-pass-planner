...
const BUILTIN_TEMPLATES: TemplateEntry[] = [
  ...
  { id: "beta_welcome", label: "🧪 Beta Welcome", storageKey: "beta_welcome_template", placeholders: "{{first_name}}, {{app_url}}, {{beta_link}}", isBuiltin: true, createdAt: "2024-01-01" },
