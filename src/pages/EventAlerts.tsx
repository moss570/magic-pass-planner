              ...
              {selectedEvent ? (
                ...
                <div className="relative">
                  ...
                  {showEventDropdown && filteredEvents.length > 0 && (
                    <div className="absolute top-full left-0 right-0 z-50 mt-1 rounded-lg border border-white/10 overflow-hidden shadow-xl" <div className="absolute top-full left-0 right-0 z-50 mt-1 rounded-lg border border-white/10 overflow-hidden shadow-xl" style={{ background: "#141C2E", maxHeight: 280 }}>>
