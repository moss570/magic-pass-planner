...
const sections = [
  { title: "🚀 Getting Started", faqs: [
    ...
    { q: "What parks does Magic Pass Plus support?", a: "Currently: Walt Disney World Resort (Orlando) and Disneyland Resort (California). Additional parks — including Universal Studios, Universal's Epic Universe, and SeaWorld — are coming after launch." },
    { q: "Does Magic Pass Plus book reservations for me?", a: "No — we notify you the moment a reservation opens and you complete the booking yourself through Disney's official site or app. This keeps your Disney account safe and fully in your control." },
  ]},
  { title: "🔔 Alerts & Notifications", faqs: [
    { q: "I set up an alert but haven't heard anything. What should I check?", a: "Check that the alert is Active in your Dashboard. Check spam/junk folders. Verify your phone number for SMS. Try widening your date range or time window. Still nothing after 24 hours? Email us." },
