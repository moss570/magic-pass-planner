...
const MK_LOCATIONS: Record<string, {
  ...
  "Buzz Lightyear's Space Ranger Spin":{ x:82, y:68, land:"Tomorrowland", rideTime:5, category:"ride", thrillLevel:2, avgWait:{low:15,moderate:30,high:50}, llAvailable:false, tips:"🆕 REOPENED April 8, 2026 with new ride vehicles, handheld blasters, and character Buddy. Interactive shooter ride for all ages." },
  ...
  "Aloha Isle":                      { x:17, y:57, land:"Adventureland", rideTime:5, category:"dining", thrillLevel:1, avgWait:{low:3,moderate:8,high:15}, llAvailable:false, tips:"Dole Whip! The only place to get it in MK.", diningType:"snack", servesMeals:[] },
...
function nearbyDining(location: string, park: string): string[] {
  ...
  const parkLocations: Record<string, any> = {
    ...
    "Animal Kingdom": {
      ...
      // DINOSAUR: PERMANENTLY CLOSED Feb 2, 2026 - being replaced by Tropical Americas land
